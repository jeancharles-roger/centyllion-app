...
fun emptyModelAndSimulation(width: Int = 100, height: Int = 100): Simulation {
    val model = GrainModel("empty", width, height)
...
fun carModel(width: Int = 100, height: Int = 100): GrainModel {
    ...
    return GrainModel("Cars", width, height, 1, "On the road again", listOf(road, carFront, carBack), listOf(move, reverse))
}
...
fun bacteriaModel(width: Int = 100, height: Int = 100): GrainModel {
    ...
    return GrainModel("Bacteria", width, height, 1, "", listOf(bacteria, sugar), listOf(division))
}
...
fun immunityModel(width: Int = 100, height: Int = 100): GrainModel {
    ...
    return GrainModel("Immunity system", width, height, 1, "",
