...
private fun Grain.diagnose(model: GrainModel, locale: Locale, result: MutableList<Problem>) {
    if (halfLife < 0) {
...
private fun Behaviour.diagnose(model: GrainModel, locale: Locale, result: MutableList<Problem>) {
    if (mainReactiveId < 0) {
...
private fun Reaction.diagnose(model: GrainModel, behaviour: Behaviour, index: Int, locale: Locale, result: MutableList<Problem>) {
