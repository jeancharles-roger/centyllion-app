...
open class AppState(
    ...
    private val pathState = mutableStateOf<PlatformFile?>(null)
    ...
    private val modelState = mutableStateOf(emptyModel())
    ...
    suspend fun startSimulation() {
        if (!running) {
            ...
            while (running) {
                step()
                delay((250 * (1f - speed)).roundToLong().coerceIn(1, 250))
            }
        }
    }
    ...
    private suspend fun loadModel(path: PlatformFile): ModelAndSimulation =
        try {
            val source = path.readBytes().decodeToString()
    ...
    */
    ...
    override var selectedProblem: Problem?
        ...
        set(value) {
            selectedProblemState.value = value
        }
    ...
    private fun addLog(message: String, severity: Severity) {
        ...
        logsState.value += AppLog(message, severity)
        // TODO log tab
    ...
    override var centerSelectedTab: Tab
        ...
        set(value) {
            centerSelectedTabState.value = value
        }
    ...
    override var eastSelectedTab: Tab
        ...
        set(value) {
            eastSelectedTabState.value = value
        }
